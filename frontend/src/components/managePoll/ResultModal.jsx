  ...
  return (
    <Dialog.Root open={!!resultData} onOpenChange={(open) => !open && clearResult()}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          className="fixed top-1/2 left-1/2 w-96 -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg p-6 shadow-lg focus:outline-none data-[state=open]:animate-scaleIn"
        >
